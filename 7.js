...
class EmployeeGroup {
  employees = [];    // Задаємо властивість employees, яке призначене для зберігання працівників. Він ініціалізується як порожній масив.
...
class EmployeeIterator {
  ...
  constructor(employeeGroup){
    ...
    this.#employees = employeeGroup.employees;    // Робимо властивість #employees - це масив працівників, по якому ми будемо ітерувати. Він ініціалізується у конструкторі.
  ...
  list(){
    return employeeGroup.employees.map((employee) => employee.name).join(', ');
